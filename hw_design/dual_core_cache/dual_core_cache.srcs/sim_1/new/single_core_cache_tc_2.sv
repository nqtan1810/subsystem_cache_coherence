...
module single_core_cache_tc_2();
    ...
    initial begin
        ...
        // write with addr = 32'heedc_ba98 --> miss
        repeat (5) @(posedge ACLK);
        m_AWVALID <= 1;
        m_AWADDR <= 32'heedc_ba98;
        do begin
            @(posedge ACLK);
        end while (!m_AWREADY);
        m_AWVALID <= 0;
        ...
        // write with addr = 32'hdedc_ba98 --> miss
        repeat (5) @(posedge ACLK);
        m_AWVALID <= 1;
        m_AWADDR <= 32'hdedc_ba98;
        do begin
            @(posedge ACLK);
        end while (!m_AWREADY);
        m_AWVALID <= 0;
        ...
        // write with addr = 32'hcedc_ba98 --> miss
        repeat (5) @(posedge ACLK);
        m_AWVALID <= 1;
        m_AWADDR <= 32'hcedc_ba98;
        do begin
            @(posedge ACLK);
        end while (!m_AWREADY);
        m_AWVALID <= 0;
