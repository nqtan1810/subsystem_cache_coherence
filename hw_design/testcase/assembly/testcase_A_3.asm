...
store_loop1:
    ...
    # Generate constant x6 = 0x2468A0BD using LUI + ORI (no LI)
    lui     x6, 0x2468A               # x6 = 0x2468A000
    ori     x6, x6, 0x0BD             # x6 = 0x2468A0BD 

    xor     x5, x5, x6                # pseudo-random base (x5 ^= x6 = 0x2468A0BD)
